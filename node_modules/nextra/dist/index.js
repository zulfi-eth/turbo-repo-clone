  ...
  return __async(this, arguments, function* (dir, route = "/", fileMap = /* @__PURE__ */ Object.create(null)) {
    ...
    const promises = files.map((f) => __async(this, null, function* () {
      ...
      if (fileName === "meta.json") {
        console.warn('[nextra] "meta.json" was renamed to "_meta.json". Rename the following file:', import_node_path4.default.relative(CWD, filePath));
      }
    }));
    ...
    for (const locale of locales) {
      ...
      const defaultMeta = mdxPages.filter((item) => item.locale === locale).map((item) => {
        ...
        return [
          item.name,
          ((_a2 = item.frontMatter) == null ? void 0 : _a2.title) || (0, import_title.default)(item.name.replace(/[-_]/g, " "))
        ];
      });
  ...
  return __spreadProps(__spreadValues({}, nextConfig), {
    ...
    webpack(config2, options) {
      ...
      const nextraLoaderOptions = __spreadProps(__spreadValues({}, nextraConfig), {
        ...
        allowFutureImage: (_e = (_d = nextConfig.experimental) == null ? void 0 : _d.images) == null ? void 0 : _e.allowFutureImage
      });
